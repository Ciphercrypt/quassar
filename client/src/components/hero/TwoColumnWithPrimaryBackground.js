  ...
  return (
    ...
    <Container>
        <TwoColumn>
          <LeftColumn>
            <Heading>
             Traffic Monitoring,optimization and tracking<span tw="text-primary-500"> for you.</span>
            </Heading>
            <Paragraph>....</Paragraph>
            <Actions>
              <input type="text"   placeholder="Enter CCTV ID or location.." onChange={e => setInputID(e.target.value)} />
